...
def blocks_for(page: str) -> dict[str, str]:
    ...
    if page == "index":
        ...
        out["JSONLD"] = _jsonld(
            ...
            f"Daily bull/neutral/bear regime states from SMA, EMA and HMM models across 20 global markets. {_brief_sentence(snap)}",
        )
...
def _today_blocks(snap: dict) -> dict[str, str]:
    ...
    return {
        ...
        "JSONLD": _jsonld(
            ...
            f"Market regime daily brief for {snap['as_of']}: risk gauge {snap['gauge']:.0f}/100 across 20 global markets, NSE smart-money flows, valuation percentiles.",
        ),
    }
